...
<body>
<fieldset>
    <div style="background-color: cornflowerblue; width: 100%; padding: 2px;">
        <p style="color: #f5f5f5; text-align: left; font-family: Arial, sans-serif; font-size: small">THÔNG BÁO</p>
    </div>
    <h3 style="text-align: center">Chúc mừng bạn!</h3>
